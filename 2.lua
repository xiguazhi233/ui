...
function Library:NewToggle(name, tabID, callback)
    ...
    -- ===== 防御：如果 MainFrame 还没创建，使用默认位置 =====
    local mainPos = UI.MainFrame and UI.MainFrame.Position or Vector2.new(0, 0)
    Button.Position = mainPos + Vector2.new(15, 50 + #tab.Buttons * 30)
    Button.Size = 18
